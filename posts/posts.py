...
from dschmidt_cdktf_provider_google_beta.google_compute_network import GoogleComputeNetwork
...
class Posts(Resource):
    ...
    def __init__(self, scope: Construct, id: str, environment: str, user: str, project: str):
        ...
        private_ip = GoogleComputeGlobalAddress(self,
                                                name="internal-ip-address-{}-{}".format(
                                                    environment, user),
                                                id_="internal-ip-address-{}-{}".format(
                                                    environment, user),
                                                project=project,
                                                purpose="VPC_PEERING",
